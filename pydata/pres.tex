...
\begin{frame}{What to expect from my presentation}
 ...
 \begin{itemize}
  ...
  \onslide<2-> \item Which biomarkers can we predict, and which we cannot? (clinical diagnosis, MRI, cognitive tests)
  ...
  \onslide<6-> \item How well do algorithms work on ``real data'', i.e. clinical trials?
