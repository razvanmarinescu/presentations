...
\begin{itemize}
\item No algorithm could predict ADAS scores in TADPOLE Challenge
\end{itemize}
\vspace{2em}
...
\item Segmentation results still inaccurate
\begin{itemize}
\item SOTA placenta segmentation is \textcolor{red}{semi}-automatic, Wang et al, 2019
\end{itemize}
