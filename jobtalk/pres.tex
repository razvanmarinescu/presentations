...
%\begin{itemize}
%\item Committed to foster diversity and inclusion across gender, race, ethnicity, income
%\item Ensure students of any background can excel
%\end{itemize}
%
%\vo
%
%\begin{center}
%\textbf{Past Diversity Initiatives}
%%\vspace{-1em}
%\end{center}
%\begin{columns}[t]
%\begin{column}{0.5\textwidth}
...
%%\end{center}
%
%As President of the MIT Postdoctoral Association:
%\begin{itemize}
%\item Worked to create a thriving environment for all postdocs at MIT
%\item Served on hiring committee for the MIT ICEO
%\item Launched a DEI journal club
%\end{itemize}
%%\centering
%\end{column}
%\begin{column}{0.5\textwidth}
...
%
%%\begin{itemize}
%Taught classes to students with limited financial means
%%\end{itemize}
%%(Oxford for Romania Summer School, 2018)
%
%\end{column}
%\end{columns}
%
