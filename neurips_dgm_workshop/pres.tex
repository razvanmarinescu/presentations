...
\begin{frame}{Aim: Image reconstruction using pre-trained Deep Generative Models}
...
$$p(I|I_{CLN}) \coloneqq p(I|f \ci G(w)) = p(I|f \ci G(w)) \left| \frac{\partial f \ci G(w)}{\partial G(w)} \right|^{-1}$$
